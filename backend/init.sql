...
-- ---- user_auth -------------------------------------------------------------
-- IMPORTANT: these are SAMPLE bcrypt hashes for the literal password
-- "password123" — placeholders for local testing only. Real hashes must be
-- generated by the app at registration time; never insert plaintext here.
INSERT INTO user_auth (user_id, password_hash) VALUES
  ...
  (4, '$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy');
